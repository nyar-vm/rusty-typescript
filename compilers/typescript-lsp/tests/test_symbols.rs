use typescript_lsp::lsp::symbols::{Symbol, SymbolKind, SymbolTable, ScopeType}; use oak_core::Range;

#[test]
fn test_symbol_creation() {
    let symbol = Symbol::new("myVar".to_string(), SymbolKind::Variable, Range::from(0..10))
