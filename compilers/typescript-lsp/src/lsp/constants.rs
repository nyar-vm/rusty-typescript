...
pub const STRING_METHODS: &[&str] = &[
    ...
    "indexOf", "lastIndexOf", "length", "localeCompare", "match",
...
pub const ARRAY_METHODS: &[&str] = &[
    ...
    "lastIndexOf", "length", "map", "pop", "push", "reduce",
